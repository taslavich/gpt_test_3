...
func (c *orchestratorServiceClient) GetWinnerBid_V2_5(ctx context.Context, in *OrchestratorRequest_V2_5, opts ...grpc.CallOption) (*OrchestratorResponse_V2_5, error) {
	...
	out := new(OrchestratorResponse_V2_5)
	err := c.cc.Invoke(ctx, OrchestratorService_GetWinnerBid_V2_5_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrchestratorServiceServer) GetWinnerBid_V2_5(context.Context, *OrchestratorRequest_V2_5) (*OrchestratorResponse_V2_5, error) {
	return nil, status.Error(codes.Unimplemented, "method GetWinnerBid_V2_5 not implemented")
}
...
func _OrchestratorService_GetWinnerBid_V2_5_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrchestratorRequest_V2_5)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrchestratorServiceServer).GetWinnerBid_V2_5(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrchestratorService_GetWinnerBid_V2_5_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrchestratorServiceServer).GetWinnerBid_V2_5(ctx, req.(*OrchestratorRequest_V2_5))
	}
...
var OrchestratorService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/orchestrator.proto",
}
