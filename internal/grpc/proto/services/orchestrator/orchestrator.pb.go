...
const file_services_orchestrator_proto_rawDesc = "" +
	"\n" +
	"\x1bservices/orchestrator.proto\x12\forchestrator\x1a\x1atypes/ortb_V2_5/ortb.proto\"\x90\x03\n" +
	...
	"\x04rekl\x18\x06 \x01(\bR\x04rekl\x12`\n" +
	"\rwinnerUserIds\x18\a \x03(\v2:.orchestrator.OrchestratorResponse_V2_5.WinnerUserIdsEntryR\rwinnerUserIds\x1aA\n" +
...
var file_services_orchestrator_proto_depIdxs = []int32{
	...
	4, // 4: orchestrator.OrchestratorResponse_V2_5.winnerUserIds:type_name -> orchestrator.OrchestratorResponse_V2_5.WinnerUserIdsEntry
