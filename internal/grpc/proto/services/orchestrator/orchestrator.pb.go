...
const file_services_orchestrator_proto_rawDesc = "" +
	...
	"\ffailedImpIds\x18\x04 \x03(\tR\ffailedImpIds\x12c\n" +
	"\x0eimpIdUuidClone\x18\x05 \x03(\v2;.orchestrator.OrchestratorResponse_V2_5.ImpIdUuidCloneEntryR\x0eimpIdUuidClone\x12\x12\n" +
	"\x04rekl\x18\x06 \x01(\bR\x04rekl\x12b\n" +
	"\x0fwinner_user_ids\x18\a \x03(\v2:.orchestrator.OrchestratorResponse_V2_5.WinnerUserIdsEntryR\rwinnerUserIds\x1aA\n" +
...
var file_services_orchestrator_proto_goTypes = []any{
	...
	nil,                               // 3: orchestrator.OrchestratorResponse_V2_5.ImpIdUuidCloneEntry
	nil,                               // 4: orchestrator.OrchestratorResponse_V2_5.WinnerUserIdsEntry
...
var file_services_orchestrator_proto_depIdxs = []int32{
	5, // 0: orchestrator.OrchestratorRequest_V2_5.bidRequest:type_name -> ortb_V2_5.BidRequest
	2, // 1: orchestrator.OrchestratorRequest_V2_5.impIdUuid:type_name -> orchestrator.OrchestratorRequest_V2_5.ImpIdUuidEntry
	6, // 2: orchestrator.OrchestratorResponse_V2_5.bidResponse:type_name -> ortb_V2_5.BidResponse
	3, // 3: orchestrator.OrchestratorResponse_V2_5.impIdUuidClone:type_name -> orchestrator.OrchestratorResponse_V2_5.ImpIdUuidCloneEntry
	4, // 4: orchestrator.OrchestratorResponse_V2_5.winner_user_ids:type_name -> orchestrator.OrchestratorResponse_V2_5.WinnerUserIdsEntry
	0, // 5: orchestrator.OrchestratorService.getWinnerBid_V2_5:input_type -> orchestrator.OrchestratorRequest_V2_5
	1, // 6: orchestrator.OrchestratorService.getWinnerBid_V2_5:output_type -> orchestrator.OrchestratorResponse_V2_5
