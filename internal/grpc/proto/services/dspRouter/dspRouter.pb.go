...
type DspRouterResponse_V2_5 struct {
	...
	AdvBidResponse *ortb_V2_5.BidResponse            `protobuf:"bytes,6,opt,name=adv_bid_response,json=advBidResponse,proto3" json:"adv_bid_response,omitempty"`
	WinnerUserIds  map[string]string                 `protobuf:"bytes,7,rep,name=winner_user_ids,json=winnerUserIds,proto3" json:"winner_user_ids,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *DspRouterResponse_V2_5) GetAdvBidResponse() *ortb_V2_5.BidResponse {
	if x != nil {
...
const file_services_dspRouter_proto_rawDesc = "" +
	"\n" +
	"\x18services/dspRouter.proto\x12\tdspRouter\x1a\x1atypes/ortb_V2_5/ortb.proto\"\xfb\x02\n" +
	...
	"\x04rekl\x18\x05 \x01(\bR\x04rekl\x12@\n" +
	"\x10adv_bid_response\x18\x06 \x01(\v2\x16.ortb_V2_5.BidResponseR\x0eadvBidResponse\x12\\\n" +
	"\x0fwinner_user_ids\x18\a \x03(\v24.dspRouter.DspRouterResponse_V2_5.WinnerUserIdsEntryR\rwinnerUserIds\x1aW\n" +
...
var file_services_dspRouter_proto_depIdxs = []int32{
	...
	5, // 2: dspRouter.DspRouterResponse_V2_5.bidRequest:type_name -> ortb_V2_5.BidRequest
	3, // 3: dspRouter.DspRouterResponse_V2_5.bidResponses:type_name -> dspRouter.DspRouterResponse_V2_5.BidResponsesEntry
	6, // 4: dspRouter.DspRouterResponse_V2_5.adv_bid_response:type_name -> ortb_V2_5.BidResponse
	4, // 5: dspRouter.DspRouterResponse_V2_5.winner_user_ids:type_name -> dspRouter.DspRouterResponse_V2_5.WinnerUserIdsEntry
	6, // 6: dspRouter.DspRouterResponse_V2_5.BidResponsesEntry.value:type_name -> ortb_V2_5.BidResponse
	0, // 7: dspRouter.DspRouterService.GetBids_V2_5:input_type -> dspRouter.DspRouterRequest_V2_5
	1, // 8: dspRouter.DspRouterService.GetBids_V2_5:output_type -> dspRouter.DspRouterResponse_V2_5
