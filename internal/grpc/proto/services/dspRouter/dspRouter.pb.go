...
func (x *DspRouterResponse_V2_5) GetWinnerBasePrices() map[string]float64 {
	if x != nil {
...
var file_services_dspRouter_proto_goTypes = []any{
	...
	nil,                            // 6: dspRouter.DspRouterResponse_V2_5.WinnerBasePricesEntry
...
var file_services_dspRouter_proto_depIdxs = []int32{
	...
	6,  // 7: dspRouter.DspRouterResponse_V2_5.winnerBasePrices:type_name -> dspRouter.DspRouterResponse_V2_5.WinnerBasePricesEntry
