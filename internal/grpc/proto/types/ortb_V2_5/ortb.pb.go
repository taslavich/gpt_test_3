...
type BidRequest struct {
	...
	SppEndpoint   *string                `protobuf:"bytes,10,opt,name=sppEndpoint,proto3,oneof" json:"sppEndpoint,omitempty"`
...
func (x *BidRequest) GetSppEndpoint() string {
	if x != nil && x.SppEndpoint != nil {
...
const file_types_ortb_V2_5_ortb_proto_rawDesc = "" +
	"\n" +
	"\x1atypes/ortb_V2_5/ortb.proto\x12\tortb_V2_5\"\x86\x03\n" +
	"\n" +
	"BidRequest\x12\x13\n" +
	...
	"\vsppEndpoint\x18\n" +
	" \x01(\tH\x06R\vsppEndpoint\x88\x01\x01B\x05\n" +
	"\x03_idB\x05\n" +
	"\x03_atB\t\n" +
	"\a_deviceB\a\n" +
	"\x05_siteB\a\n" +
