...
import { LayoutDashboard, Megaphone, Wallet, Settings, LogOut, BarChart3, Calculator, Menu, Webhook, UsersRound } from "lucide-react";
...
function useDashboardNavigation() {
  ...
  const menuItems = [
    ...
    { icon: UsersRound, label: t("sidebar.partners"), path: "/dashboard/partners" },
