...
const translations: Record<string, Record<"ru" | "en", string>> = {
  ...
  "formats.video.instream.desc": { ru: "VAST-реклама внутри совместимого видеоплеера: до основного ролика, во время него или после завершения.", en: "VAST advertising inside a compatible video player: before, during or after the main video." },
  "formats.video.outstream.desc": { ru: "Автономный видеоблок в статье или ленте. Запускается без звука, когда попадает в видимую область страницы.", en: "A standalone video unit inside an article or feed. It starts muted when it enters the visible area of the page." },
  "formats.video.popup.desc": { ru: "Плавающее видео поверх контента. Остаётся видимым при прокрутке и имеет кнопку закрытия.", en: "Floating video over page content. It remains visible while scrolling and includes a close button." },
  ...
  "create.step1Rtb": { ru: "Основная информация и RTB endpoint", en: "Basic info and RTB endpoint" },
  "create.launchTypeTitle": { ru: "Как вы хотите запустить кампанию?", en: "How do you want to launch the campaign?" },
  "create.launchTypeDescription": { ru: "Выберите управление креативами в кабинете или подключение своего RTB endpoint.", en: "Choose cabinet-managed creatives or connect your own RTB endpoint." },
  "create.launchCabinet": { ru: "Запуск в кабинете", en: "Launch in the cabinet" },
  "create.launchCabinetDescription": { ru: "Создайте и загрузите креативы в TwinBid, настройте таргетинг, бюджет и ставку в привычном интерфейсе.", en: "Create and upload creatives in TwinBid, then configure targeting, budget, and bidding in the familiar interface." },
  "create.launchRtb": { ru: "RTB-интеграция", en: "RTB integration" },
  "create.launchRtbDescription": { ru: "Подключите собственный RTB endpoint. Таргетинг и бюджет остаются в кабинете, а креатив и ставка приходят через интеграцию.", en: "Connect your own RTB endpoint. Targeting and budget stay in the cabinet while creatives and bidding come through the integration." },
  "create.selectLaunchType": { ru: "Выбрать", en: "Select" },
  "create.changeLaunchType": { ru: "Изменить способ запуска", en: "Change launch method" },
  "create.launchTypeCurrent": { ru: "Выбранный способ запуска", en: "Selected launch method" },
  "create.rtbEndpoint": { ru: "RTB endpoint", en: "RTB endpoint" },
  "create.rtbEndpointPlaceholder": { ru: "https://bidder.example.com/openrtb2", en: "https://bidder.example.com/openrtb2" },
  "create.rtbEndpointHint": { ru: "Укажите полный HTTP(S)-адрес endpoint, который будет принимать RTB-запросы.", en: "Enter the full HTTP(S) endpoint that will receive RTB requests." },
  "create.rtbEndpointInvalid": { ru: "Укажите корректный HTTP(S)-адрес RTB endpoint", en: "Enter a valid HTTP(S) RTB endpoint" },
  "create.videoCampaignUnsupported": { ru: "Создание и редактирование video-кампаний недоступно. Выберите Banner, Popunder, Native или In-page Push.", en: "Video campaigns can no longer be created or edited. Choose Banner, Popunder, Native, or In-page Push." },
  "create.videoUnavailable": { ru: "недоступно для кампаний", en: "unavailable for campaigns" },
  ...
  "create.formatVideo": { ru: "Видео", en: "Video" },
  ...
  "create.uploadVideo": { ru: "Загрузить видео", en: "Upload video" },
  "create.videoFormatHint": { ru: "MP4 до 10 МБ, итоговый размер 1920×1080", en: "MP4 up to 10 MB, final size 1920×1080" },
  "create.videoFormatError": { ru: "Загрузите видео в формате MP4", en: "Upload an MP4 video" },
  "create.videoFormatLabel": { ru: "Формат видео", en: "Video format" },
  "create.videoFormat.instream.desc": { ru: "Реклама внутри видеоплеера: pre-roll, mid-roll или post-roll.", en: "Advertising inside a video player: pre-roll, mid-roll or post-roll." },
  "create.videoFormat.outstream.desc": { ru: "Автономный видеоблок в статье или ленте, запускающийся в зоне видимости.", en: "A standalone video unit inside an article or feed that starts when visible." },
  "create.videoFormat.popup.desc": { ru: "Плавающее видео поверх контента с кнопкой закрытия.", en: "A floating video over the page content with a close button." },
  ...
  "edit.legacyVideoReadOnlyTitle": { ru: "Legacy video-кампания", en: "Legacy video campaign" },
  "edit.legacyVideoReadOnlyDescription": { ru: "Кампания загружена в режиме только для чтения. Backend больше не принимает video при создании или изменении кампаний.", en: "This campaign is available in read-only mode. The backend no longer accepts video when campaigns are created or updated." },
  ...
  "partners.b2b.hero.title": { ru: "Превратите связи на рекламном рынке в стабильный источник дохода", en: "Turn your advertiser network into recurring revenue" },
  "partners.b2b.hero.subtitle": { ru: "Приводите медиабайеров и рекламодателей в TwinBid и получайте 50% фактической прибыли платформы от каждого привлечённого клиента — на протяжении всего времени его работы с нами.", en: "Refer media buyers and advertisers to TwinBid and receive 50% of TwinBid's actual profit generated by every referred client — for the lifetime of the account." },
  "partners.b2b.hero.cta": { ru: "Получить партнёрскую ссылку", en: "Get your referral link" },
  "partners.b2b.hero.signalsLabel": { ru: "Ключевые условия программы", en: "Program highlights" },
  "partners.b2b.hero.metricProfit": { ru: "фактической прибыли TwinBid", en: "of TwinBid's actual profit" },
  "partners.b2b.hero.metricLifetimeValue": { ru: "Всё время", en: "Lifetime" },
  "partners.b2b.hero.metricLifetime": { ru: "пока клиент работает", en: "revenue from every client" },
  "partners.b2b.hero.metricRealtimeValue": { ru: "Онлайн", en: "Real-time" },
  "partners.b2b.hero.metricRealtime": { ru: "начисление дохода", en: "earnings credited as they spend" },
  "partners.b2b.handled.eyebrow": { ru: "После знакомства", en: "After the introduction" },
  "partners.b2b.handled.title": { ru: "Вы передаёте контакт. TwinBid ведёт рекламодателя дальше.", en: "You make the introduction. TwinBid takes it from there." },
  "partners.b2b.handled.onboarding": { ru: "Онбординг рекламодателя", en: "Advertiser onboarding" },
  "partners.b2b.handled.launch": { ru: "Помощь с запуском", en: "Launch assistance" },
  "partners.b2b.handled.support": { ru: "Поддержка", en: "Ongoing support" },
  "partners.b2b.handled.optimization": { ru: "Оптимизация кампаний", en: "Campaign optimization" },
  "partners.b2b.handled.technical": { ru: "Техническая часть", en: "Technical operations" },
  "partners.b2b.how.eyebrow": { ru: "Как работает программа", en: "How it works" },
  "partners.b2b.how.title": { ru: "Четыре шага от знакомства до дохода", en: "Four steps from introduction to income" },
  "partners.b2b.how.description": { ru: "Ваша задача — познакомить рекламодателя с TwinBid. Запуск, сопровождение и расчёт партнёрского дохода платформа берёт на себя.", en: "Your role is to introduce the advertiser to TwinBid. We handle the launch, support and partner earnings calculation." },
  "partners.b2b.how.step1Title": { ru: "Приведите рекламодателя", en: "Refer an advertiser" },
  "partners.b2b.how.step1Text": { ru: "Передайте рекламодателю свою персональную партнёрскую ссылку.", en: "Share your personal referral link with an advertiser or media buyer." },
  "partners.b2b.how.step2Title": { ru: "Рекламодатель покупает трафик", en: "The advertiser buys traffic" },
  "partners.b2b.how.step2Text": { ru: "Он пополняет баланс и запускает закупку трафика через TwinBid.", en: "They fund the account and start buying traffic through TwinBid." },
  "partners.b2b.how.step3Title": { ru: "Вы получаете 50% прибыли", en: "You earn 50% of our profit" },
  "partners.b2b.how.step3Text": { ru: "Половина фактической прибыли TwinBid от клиента начисляется Вам.", en: "Half of TwinBid's actual profit from that client is credited to you." },
  "partners.b2b.how.step4Title": { ru: "Запросите выплату", en: "Withdraw your earnings" },
  "partners.b2b.how.step4Text": { ru: "Доступный партнёрский баланс можно вывести на криптовалютный кошелёк.", en: "Request the available partner balance directly to your crypto wallet." },
  "partners.b2b.earnings.eyebrow": { ru: "Начисление дохода", en: "Real-time earnings" },
  "partners.b2b.earnings.title": { ru: "Доход растёт вместе с расходами рекламодателя", en: "Your earnings grow as the advertiser spends" },
  "partners.b2b.earnings.text": { ru: "Начисление происходит не в момент депозита. Партнёрский баланс обновляется по мере того, как привлечённый рекламодатель фактически расходует средства на покупку трафика.", en: "Earnings are not credited when the advertiser deposits. Your partner balance updates as the referred advertiser actually spends funds on traffic." },
  "partners.b2b.earnings.flowSpend": { ru: "Рекламодатель расходует средства", en: "Advertiser spends on traffic" },
  "partners.b2b.earnings.flowProfit": { ru: "TwinBid получает прибыль", en: "TwinBid generates profit" },
  "partners.b2b.earnings.flowShare": { ru: "50% начисляется Вам", en: "50% is credited to you" },
  "partners.b2b.payouts.eyebrow": { ru: "Выплаты", en: "Payouts" },
  "partners.b2b.payouts.title": { ru: "Выводите доход, когда это необходимо", en: "Withdraw whenever you need" },
  "partners.b2b.payouts.text": { ru: "Запрашивайте партнёрский доход напрямую на свой криптовалютный кошелёк.", en: "Request your partner earnings directly to your crypto wallet." },
  "partners.b2b.payouts.request": { ru: "Выплата производится по Вашему запросу", en: "Payouts are made on request" },
  "partners.b2b.payouts.daily": { ru: "Один запрос на выплату в сутки", en: "One payout request per day" },
  "partners.b2b.payouts.crypto": { ru: "Получение на криптовалютный кошелёк", en: "Paid directly to a crypto wallet" },
  "partners.b2b.payouts.balance": { ru: "Доступен весь накопленный партнёрский баланс", en: "Your accumulated available balance can be withdrawn" },
  "partners.b2b.calculator.eyebrow": { ru: "Калькулятор дохода", en: "Earnings calculator" },
  "partners.b2b.calculator.title": { ru: "Оцените доход с Вашей сети медиабайеров", en: "Estimate the value of your media buyer network" },
  "partners.b2b.calculator.description": { ru: "Возьмите одного из Ваших действующих медиабайеров, укажите его экономику и сразу оцените потенциальный ежемесячный и годовой доход.", en: "Use the economics of one existing media buyer to estimate your potential monthly and annual partner income." },
  "partners.b2b.calculator.payout": { ru: "Ежемесячная выплата медиабайеру от партнёрской программы", en: "Monthly affiliate payout to the media buyer" },
  "partners.b2b.calculator.roi": { ru: "Предполагаемый ROI медиабайера", en: "Estimated media buyer ROI" },
  "partners.b2b.calculator.roiHint": { ru: "ROI = (Доход − расходы на трафик) / расходы на трафик", en: "ROI = (Revenue − Traffic Spend) / Traffic Spend" },
  "partners.b2b.calculator.buyers": { ru: "Количество похожих медиабайеров", en: "Number of similar media buyers" },
  "partners.b2b.calculator.formula": { ru: "Расходы на трафик = доход / (1 + ROI). Маржа TwinBid задана внутри модели и не является пользовательским параметром.", en: "Traffic Spend = Revenue / (1 + ROI). The estimated TwinBid margin is built into the model and is not a user input." },
  "partners.b2b.calculator.trafficSpend": { ru: "Предполагаемые расходы на трафик", en: "Estimated traffic spend" },
  "partners.b2b.calculator.twinbidProfit": { ru: "Предполагаемая прибыль TwinBid", en: "Estimated TwinBid profit" },
  "partners.b2b.calculator.partnerIncome": { ru: "Ваш предполагаемый партнёрский доход", en: "Your estimated partner income" },
  "partners.b2b.calculator.annualIncome": { ru: "Потенциальный годовой доход", en: "Potential annual income" },
  "partners.b2b.calculator.month": { ru: "месяц", en: "month" },
  "partners.b2b.calculator.year": { ru: "год", en: "year" },
  "partners.b2b.calculator.disclaimer": { ru: "Расчёт носит оценочный характер. Фактический партнёрский доход зависит от реальных расходов рекламодателей и фактической прибыли TwinBid.", en: "This is an estimate. Actual partner income depends on advertiser spend and the actual profit generated by TwinBid." },
  "partners.b2b.example.eyebrow": { ru: "Готовый пример", en: "Example economics" },
  "partners.b2b.example.title": { ru: "Экономика одного активного медиабайера", en: "The economics of one active media buyer" },
  "partners.b2b.example.spend": { ru: "Расходы медиабайера в месяц", en: "Media buyer monthly spend" },
  "partners.b2b.example.profit": { ru: "Прибыль TwinBid", en: "TwinBid profit" },
  "partners.b2b.example.share": { ru: "Ваши 50% в месяц", en: "Your 50% per month" },
  "partners.b2b.example.annual": { ru: "При той же активности за год", en: "At the same activity level per year" },
  "partners.b2b.example.lifetime": { ru: "Пока привлечённый рекламодатель продолжает закупать трафик через TwinBid и генерировать прибыль, Вы продолжаете получать 50% этой прибыли. Это не разовая комиссия, а доход на всё время работы клиента.", en: "As long as the referred advertiser keeps buying traffic through TwinBid and generating profit, you continue receiving 50% of that profit. It is not a one-time commission — it lasts for the lifetime of the client." },
